                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li><a href="<?php echo e(route('view_all_courses')); ?>" class=" hvr-bounce-to-right"> <i class="fa fa-file-o nav_icon"></i>View all groups</a></li>

                                <li><a href="<?php echo e(route('add_new_course')); ?>" class=" hvr-bounce-to-right"><i class="fa fa-file-o nav_icon"></i>Add new group</a></li>
